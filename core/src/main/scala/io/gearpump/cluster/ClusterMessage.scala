...
object MasterToClient {
   ...
   *
   * All metrics is organized like a xml tree, path is used to navigate the tree. For example,
   * path == "executor0.task1.throughput*" will pick metrics whose source matches the path.
   *
