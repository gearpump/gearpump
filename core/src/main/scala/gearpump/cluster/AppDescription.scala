...
import gearpump.jarstore.JarFileContainer
 ...
 * @param mainClass Executor main class name like gearpump.xx.AppMaster
 ...
 * use gearpump.util.Constants.GEARPUMP_CUSTOM_CONFIG_FILE to pass the config to executor
 * process
 *
 */
