...
package gearpump.transport

import akka.actor._
import akka.agent.Agent
import gearpump.transport.netty.Client.Close
import gearpump.transport.netty.{Context, TaskMessage}
...
class Express(val system: ExtendedActorSystem) extends Extension with ActorLookupById {
  ...
  import gearpump.transport.Express._
