 ...
 */
package gearpump.cluster

import _root_.akka.actor.{ActorSystem, PoisonPill, Props}
import akka.testkit.TestProbe
import com.typesafe.config.ConfigFactory
import gearpump.cluster.AppMasterToWorker.{LaunchExecutor, ShutdownExecutor}
import gearpump.cluster.MasterToWorker.{UpdateResourceFailed, WorkerRegistered}
import gearpump.cluster.WorkerToAppMaster.{ShutdownExecutorSucceed, ShutdownExecutorFailed, ExecutorLaunchRejected}
import gearpump.cluster.WorkerToMaster.{RegisterNewWorker, RegisterWorker, ResourceUpdate}
import gearpump.cluster.master.Master.MasterInfo
import gearpump.cluster.scheduler.Resource
import gearpump.cluster.worker.Worker
import gearpump.util.{ActorSystemBooter, ActorUtil, Constants}
