...
import gearpump.cluster.AppMasterToWorker.{ShutdownExecutor, LaunchExecutor}
...
import gearpump.cluster.scheduler.{ResourceRequest, Resource, ResourceAllocation}
