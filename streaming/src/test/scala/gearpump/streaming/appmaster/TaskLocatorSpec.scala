...
import TaskLocator.{NonLocality, WorkerLocality}
...
class TaskLocatorSpec extends WordSpec with Matchers {
  ...
  val taskDescription1 = ProcessorDescription("gearpump.streaming.appmaster.TestTask1", 4)
  val taskDescription2 = ProcessorDescription("gearpump.streaming.appmaster.TestTask2", 2)
  val taskDescription3 = ProcessorDescription("gearpump.streaming.appmaster.TestTask3", 2)
