 ...
 */
package gearpump.experiments.distributeservice

import akka.actor.ActorSystem
import akka.testkit.{TestActorRef, TestProbe}
import gearpump.experiments.distributeservice.DistServiceAppMaster.{FileContainer, GetFileContainer}
import gearpump.cluster.AppMasterToMaster.{RequestResource, GetAllWorkers, RegisterAppMaster}
import gearpump.cluster.AppMasterToWorker.LaunchExecutor
import gearpump.cluster.MasterToAppMaster.{ResourceAllocated, WorkerList, AppMasterRegistered}
import gearpump.cluster.appmaster.AppMasterRuntimeEnvironment
import gearpump.cluster.master.AppMasterRuntimeInfo
import gearpump.cluster.{AppMasterContext, UserConfig, AppDescription, TestUtil}
import gearpump.cluster.scheduler.{ResourceAllocation, Relaxation, ResourceRequest, Resource}
import DistServiceAppMaster.{FileContainer, GetFileContainer}
import gearpump.util.ActorSystemBooter.RegisterActorSystem
import gearpump.util.ActorUtil
