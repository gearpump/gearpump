...
package main.scala.org.apache.gearpump.experiments.hbase

import org.apache.gearpump._
import org.apache.gearpump.streaming.source.DataSource
import org.apache.gearpump.streaming.task.TaskContext
import org.apache.hadoop.conf.Configuration
import org.apache.hadoop.hbase.client.{HTable, Scan, ResultScanner}
import org.apache.hadoop.hbase.{CellScanner, Cell, CellUtil}
...
class HBaseDataSource(hbaseConf : Configuration, tableName : String, families: Array[String], useCurrentTime : Boolean) extends DataSource {
  ...
  private def restartScanner = {
    closeScanner
    val scan = new Scan()
    scan.setTimeRange(timeStamp, Long.MaxValue)
