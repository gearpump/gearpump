...
import io.gearpump.cluster.ClientToMaster.{ShutdownApplication, SubmitApplication}
import io.gearpump.cluster.MasterToClient.{ShutdownApplicationResult, SubmitApplicationResult}
