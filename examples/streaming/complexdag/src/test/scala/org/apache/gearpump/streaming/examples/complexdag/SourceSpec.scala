...
class SourceSpec extends WordSpec with Matchers {
  ...
  "Source" should {
    "Source should send a msg of Array[String](classOf[Source].getCanonicalName)" in {
      ...
      verify(context).output(argMatch[Message](Array(classOf[Source].getCanonicalName) == _.msg))
    }
  }
}
