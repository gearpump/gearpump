...
package gearpump.streaming.examples.stock.main

import akka.actor.ActorSystem
import gearpump.cluster.main.ArgumentsParser
import gearpump.streaming.{StreamApplication, Processor}
import gearpump.streaming.examples.stock.{Crawler, StockMarket, QueryServer, Analyzer}
...
import gearpump.util.Graph.{Path, Node}
